...
import { idlFactory } from './demo_project.did.js';
export { idlFactory } from './demo_project.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DEMO_PROJECT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./demo_project.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the demo_project canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./demo_project.did.js")._SERVICE>}
 */
export const demo_project = createActor(canisterId);
